...
<label>First name:</label>
  <input class="info" type="text" id="fname" name="fname">
  
  <br>
  <br>
<label>Last name:</label>
  <input class="info" type="text" id="lname" name="lname">
...
<label>phone number:</label>
  <input  class="info" type="text" id="phone" name="phone">
...
<label>Password:</label>
  ...
  <input class="info" type="password" id="password" name="password">
   ...
   <br>
   <br>
   <button  class = "submit" type="submit" id="submit" onclick="">Submit</button>   <br>
   </br>
   </br>
</form>
</fieldset>
